...
export async function materialsFixture(productCount=1,templateId='juno-toys'):Promise<MaterialsSubmission>{
  const profile=getMaterialsTemplate(templateId,templateId==='juno-toys'?'2026-09-17.juno-materials.2':`2026-09-17.${templateId}-materials.${templateId==='senseng-video'?2:1}`)!;
