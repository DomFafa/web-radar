...
const TEMPLATE_PREVIEWS: Record<string, string> = {
  ...
  'single-device-showcase': '/templates/previews/single-device-showcase.jpg',
  'single-artisan-craft': '/templates/previews/single-artisan-craft.jpg',
  'single-wellness-nordic': '/templates/previews/single-wellness-nordic.jpg',
