...
/* ------------------------------------------------------------- */
/* 06b. B2B PRODUCT TEMPLATES — BODY & INTERACTION STYLES        */
/* ------------------------------------------------------------- */

/* ── Footwear (Dark Mode — 运动科技/力学工程) ── */
body[data-template="footwear-craft-banner"],
body[data-template="footwear-kinetic-video"] {
  background: #0a0f1e;
  color: #f1f5f9;
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;
  -webkit-font-smoothing: antialiased;
...
body[data-template="footwear-craft-banner"] .fw-card:hover,
body[data-template="footwear-kinetic-video"] .fw-card:hover {
  transform: translateY(-8px) scale(1.015);
  border-color: rgba(56, 189, 248, 0.35) !important;
  box-shadow: 0 20px 50px rgba(14, 165, 233, 0.18), 0 0 0 1px rgba(56, 189, 248, 0.2) !important;
}
body[data-template="footwear-craft-banner"] .fw-card:hover img,
body[data-template="footwear-kinetic-video"] .fw-card:hover img {
  transform: scale(1.06);
}

/* ── Toys & Figures (Bright — 童趣多彩/安全活力) ── */
body[data-template="toys-figure-banner"],
body[data-template="toys-interactive-video"] {
  background: #fafbfe;
  color: #1e293b;
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;
  -webkit-font-smoothing: antialiased;
...
/* ── Plush & Cushion (Soft Pink — 柔软温馨/家居生活) ── */
body[data-template="plush-cushion-banner"],
body[data-template="plush-living-video"] {
  background: #fef7f7;
  color: #1e293b;
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;
  -webkit-font-smoothing: antialiased;
...
/* ── Apparel & Textile (Warm Ivory — 时尚面料/工艺质感) ── */
body[data-template="apparel-fabric-banner"],
body[data-template="apparel-runway-video"] {
  background: #faf9f6;
  color: #0f172a;
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;
  -webkit-font-smoothing: antialiased;
...
/* ── Universal Trade (Clean Professional — B2B国际贸易) ── */
body[data-template="universal-trade-banner"],
body[data-template="universal-showcase-video"] {
  background: #f8fafc;
  color: #0f172a;
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;
  -webkit-font-smoothing: antialiased;
...
/* ------------------------------------------------------------- */
/* 07. 10 NEW TEMPLATES DEDICATED BASE STYLES & LIQUID GLASS     */
/* ------------------------------------------------------------- */
