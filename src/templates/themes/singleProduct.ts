  ...
  const headerHtml = `
    <header style="position:sticky;top:0;z-index:90;background:rgba(8,9,14,0.85);backdrop-filter:blur(16px);border-bottom:1px solid rgba(0,240,255,0.15);padding:14px 24px;">
      <div class="sd-header-inner" style="max-width:1320px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;gap:20px;">
        ...
        <nav class="sd-nav" style="display:flex;align-items:center;gap:24px;">
  ...
  const footerHtml = `
    <footer style="background:#040508;color:rgba(255,255,255,0.7);padding:60px 24px 32px;border-top:1px solid rgba(0,240,255,0.12);">
      <div style="max-width:1320px;margin:0 auto;">
        <div class="sd-footer-grid" style="display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:40px;margin-bottom:40px;">
          <div>
    ...
    mainHtml = `
      <main style="background:#08090e;color:#ffffff;overflow:hidden;">
        ...
        <section style="position:relative;padding:90px 24px 100px;min-height:92vh;display:flex;align-items:center;justify-content:center;border-bottom:1px solid rgba(0,240,255,0.12);">
          ...
          <div class="sd-hero-grid" style="max-width:1320px;width:100%;margin:0 auto;display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:center;position:relative;">
            <div>
              ...
              <div class="sd-hero-stats" style="display:grid;grid-template-columns:repeat(3, 1fr);gap:16px;padding-top:24px;border-top:1px solid rgba(255,255,255,0.1);">
                <div>
    ...
    mainHtml = `
      <main style="background:#08090e;color:#ffffff;padding:80px 24px;">
        <div style="max-width:1320px;margin:0 auto;">
          ...
          <div class="sd-spec-grid" style="display:grid;grid-template-columns:repeat(auto-fill, minmax(260px, 1fr));gap:32px;">
            ${products.map((p, idx) => {
          ...
          <div class="sd-detail-main-grid" style="display:grid;grid-template-columns:1.1fr 0.9fr;gap:60px;align-items:flex-start;margin-bottom:80px;">
            ...
            <div>
              ...
              <div style="background:rgba(255,255,255,0.04);border-radius:12px;padding:24px;border:1px solid rgba(255,255,255,0.1);margin-bottom:32px;">
                ...
                <div class="sd-detail-subspecs" style="display:grid;grid-template-columns:1fr 1fr;gap:16px;font-size:0.88rem;">
                  <div>
    ...
    mainHtml = `
      <main style="background:#08090e;color:#ffffff;padding:80px 24px;">
        <div style="max-width:960px;margin:0 auto;">
          ...
          <div class="sd-detail-specs" style="display:grid;grid-template-columns:repeat(3, 1fr);gap:24px;padding:36px;background:#11131c;border:1px solid rgba(0,240,255,0.2);border-radius:16px;">
            <div>
    ...
    mainHtml = `
      <main style="background:#fcfaf6;color:#1e1915;padding:90px 32px;">
        <div style="max-width:1320px;margin:0 auto;">
          ...
          <div class="sa-provenance-grid" style="display:grid;grid-template-columns:repeat(auto-fill, minmax(260px, 1fr));gap:36px;">
            ${products.map((p, idx) => {
