...
const suppliedFacts = (draft: Draft) => ({
  ...
  products: draft.products.map((product) => ({
    ...
    gallery: product.gallery?.map(({kind,caption})=>({kind,caption})),
