...
export const templateMediaRequirements: Partial<Record<TemplateId, TemplateMediaRequirements>> = {
  ...
  'luggage-leather-banner': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 960（8:3 手工植鞣皮革与旅行箱体质感留白展台）',
    bannerNote: '头层牛皮纹理微距光影与工匠黄铜五金展台已内置。',
    videos: 0,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'luggage-voyage-video': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 1440（16:9 国际机场登机与世界漫游全屏视频，适配 2K/4K）',
    bannerNote: '万向轮静音滑行、行李箱防刮跌落测试与国际机场漫游全屏短片已内置。',
    videos: 1,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'jewelry-luxury-banner': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 960（8:3 黑金典雅暗调黑曜石展台与高定光晕）',
    bannerNote: '莫桑钻火彩微距与黑曜石珠宝展台已内置。',
    videos: 0,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'jewelry-timeless-video': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 1440（16:9 机械机芯透视陀飞轮与宝石火彩慢镜视频，适配 2K/4K）',
    bannerNote: '高级制表机械摆轮运转与钻石全反射微距全屏视频已内置。',
    videos: 1,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'homedecor-aesthetic-banner': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 960（8:3 侘寂意境陶艺与自然光影空间画卷）',
    bannerNote: '手工素烧陶艺、光影流转与日式插花雅致空间已内置。',
    videos: 0,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'homedecor-living-video': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 1440（16:9 晨光穿透百叶窗与香薰烟雾流转慢镜视频，适配 2K/4K）',
    bannerNote: '晨光微尘百叶窗、香薰袅袅与现代美学家居全屏动态短片已内置。',
    videos: 1,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'furniture-minimal-banner': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 960（8:3 包豪斯极简悬浮与空间收纳构图展台）',
    bannerNote: '榫卯结构微距、白蜡木原木纹理与极简收纳系统已内置。',
    videos: 0,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'furniture-spatial-video': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 1440（16:9 空间折叠变形家具与智能收纳演示全屏视频，适配 2K/4K）',
    bannerNote: '智能阻尼五金回弹与空间魔方模块变形全屏短片已内置。',
    videos: 1,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'kitchen-culinary-banner': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 960（8:3 米其林星厨烹饪台与锻造大马士革刀光展台）',
    bannerNote: '精工锻造大马士革花纹与铸铁锅原矿质感展台已内置。',
    videos: 0,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'kitchen-gourmet-video': {
    productCount: 8,
    productSize: '1200 × 1200（1:1）',
    bannerSize: '2560 × 1440（16:9 锅气升腾焰火与星级料理慢动作全屏视频，适配 2K/4K）',
    bannerNote: '高温炙烤美拉德反应与星级摆盘微距全屏短片已内置。',
    videos: 1,
    slots: [{ count: 8, width: 1200, height: 1200 }],
  },
  'saas-automation': {
